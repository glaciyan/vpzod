...
public class Configurations {
  private static final String CONFIG_FILE_NAME = ".cc.glaciyan.vpzod.config.json";
        ...
        try {
          ...
          if (e instanceof IOException)
            application
              .getViewManager()
              .showMessage(
                "vpzod: Unable to load configuration file.\n");
          else if (e instanceof JsonSyntaxException)
            application
              .getViewManager()
              .showMessage(
                "vpzod: Configuration file ill-formed.\n");
          else
            application
              .getViewManager()
              .showMessage(
                "vpzod: Unknown error while reading configuration file.\n");
  ...
  public void save() {
    ...
    try {
      ...
      application
        .getViewManager()
        .showMessage("Unable save vpzod configurations.");
      e.printStackTrace();
    }
  }
